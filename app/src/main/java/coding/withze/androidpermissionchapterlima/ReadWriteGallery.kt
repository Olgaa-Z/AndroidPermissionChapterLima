...
import coding.withze.androidpermissionchapterlima.databinding.ActivityReadWriteGalleryBinding

class ReadWriteGallery : AppCompatActivity() {

    lateinit var binding : ActivityReadWriteGalleryBinding
